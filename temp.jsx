                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-gray-200">
                    ...
                    {selectedDoubt.isMyDoubt && selectedDoubt.status !== 'resolved' && (
                      <button className="ml-auto flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-colors">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                  ...
                  <div className="mt-8 pt-6 border-t-2 border-gray-200">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center gap-2">
                        <Send size={18} />
                        Post Reply
                      </button>
                    </div>
