    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100 overflow-hidden relative flex items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <FloatingIcon delay={0.5} duration={7} x={50} y={10}>
          <BookOpen size={55} className="text-purple-400" />
        </FloatingIcon>
      </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-800 p-8 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <div className="inline-block bg-white bg-opacity-20 p-4 rounded-2xl mb-4">
                <GraduationCap className='text-purple-600' size={60} />
              </div>
              <h1 className="text-3xl font-bold mb-2">Welcome Back!</h1>
              <p className="text-purple-100">Login to continue your learning journey</p>
            </div>
          </div>
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="text-center pt-4">
              <p className="text-gray-600">
                ...
                <Link to={`/stdsignup`} className="text-purple-600 font-semibold hover:text-purple-700 transition-colors">
                  Sign Up
                </Link>
              </p>
            </div>
