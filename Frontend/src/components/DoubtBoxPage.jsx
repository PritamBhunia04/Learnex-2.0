...
export default function DoubtBoxPage() {
  ...
  const topHelpers = [
    { name: 'Aitana Bonmati', points: 1250, avatar: '👩‍🏫', replies: 89 },
    { name: 'Leonal Messi', points: 890, avatar: '👨‍💻', replies: 67 },
    { name: 'Cristiano Ronaldo', points: 765, avatar: '👩‍💼', replies: 54 },
    { name: 'Virat Kohli', points: 650, avatar: '👨‍🎓', replies: 48 }
  ];
